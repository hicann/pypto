...
from .diagnostics._exceptions import ParserError
...
def parse(code: str, filename: str = "<string>") -> ir.Function | ir.Program:
    ...
    pypto_pro.language as pl if not already present.
    ...
    Examples:
        ...
        >>> func_code = '''
        ... @pl.function
        ... def add(x: pl.Tensor[[64], pl.DT_FP32]) -> pl.Tensor[[64], pl.DT_FP32]:
        ...
        MyProgram
    """
    # Import pypto_pro.language here to avoid circular imports
    import pypto_pro.language as pl
