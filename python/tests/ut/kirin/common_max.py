...
def create_test_max_module(soc_version):
    ...
    kernels = {p.values[0]: make_max_kernel(soc_version, p.values[0], p.values[2], p.values[3]) for p in TEST_CASES}
