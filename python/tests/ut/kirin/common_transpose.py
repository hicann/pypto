...
TEST_CASES = [
    ...
    pytest.param(
        "transpose_kernel_fp16", torch.float16, pypto.DT_FP16, (1, 16), [...], (2, 3), 0, 1, marks=[], id="001"
    ),
    pytest.param(
        "transpose_kernel_fp16",
        torch.float16,
        pypto.DT_FP16,
        (1, 16),
        [...],
