...
TEST_CASES = [
    ...
    # marks: pytest marks
    pytest.param("amax_kernel_fp16_001", torch.float16, pypto.DT_FP16, (48,), (112,), (1,), -1, marks=[], id="001"),
    pytest.param(
        "amax_kernel_fp16_002",
        torch.float16,
        pypto.DT_FP16,
        (96,),
        (100,),
