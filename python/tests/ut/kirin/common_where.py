...
TEST_CASES = [
    ...
    # - shape_condition: condition tensor shape
    pytest.param(
        "where_kernel_fp16_001", torch.float16, pypto.DT_FP16, (1, 64), (2, 64), (2, 64), (2, 1), marks=[], id="001"
    ),
    pytest.param(
        "where_kernel_fp16_002",
        torch.float16,
        pypto.DT_FP16,
        (4, 16),
        (4, 32),
...
def create_test_where_module(soc_version):
    ...
    kernels = {p.values[0]: make_where_kernel(soc_version, p.values[0], p.values[2], p.values[3]) for p in TEST_CASES}
