...
TEST_CASES = [
    ...
    # - output_shape: output tensor shape (concatenation result)
    # - dim: dimension along which to concatenate
    pytest.param("concat_kernel_001", torch.int16, pypto.DT_INT16,
                 (8, 256), [(4, 128), (7, 128)], (11, 128), 0,
                 marks=[], id="001"),
    pytest.param("concat_kernel_002", torch.int32, pypto.DT_INT32,
                 (10, 200), [(4, 130), (4, 90)], (4, 220), 1,
                 marks=[pytest.mark.skip()], id="002"),
    pytest.param("concat_kernel_003", torch.float16, pypto.DT_FP16, (5, 32),
                 [(15, 31), (20, 31), (16, 31)], (51, 31), 0,
                 marks=[pytest.mark.skip()], id="003"),
    pytest.param("concat_kernel_004", torch.float32, pypto.DT_FP32, (2, 280),
                 [(4, 140), (4, 23), (4, 4)], (4, 167), 1,
                 marks=[pytest.mark.skip()], id="004"),
    pytest.param("concat_kernel_005", torch.int8, pypto.DT_INT8, (5, 5, 32),
                 [(10, 5, 12), (5, 5, 12)], (15, 5, 12), 0,
                 marks=[pytest.mark.skip()], id="005"),
    pytest.param("concat_kernel_006", torch.int16, pypto.DT_INT16, (5, 5, 400),
                 [(7, 3, 170), (7, 20, 170)], (7, 23, 170), 1,
                 marks=[pytest.mark.skip()], id="006"),
    pytest.param("concat_kernel_007", torch.int32, pypto.DT_INT32, (5, 4, 120),
                 [(9, 8, 100), (9, 8, 40)], (9, 8, 140), 2,
                 marks=[pytest.mark.skip()], id="007"),
    pytest.param("concat_kernel_008", torch.float16, pypto.DT_FP16, (10, 10, 16),
                 [(20, 40, 10), (9, 40, 10), (12, 40, 10)], (41, 40, 10), 0,
                 marks=[pytest.mark.skip()], id="008"),
    pytest.param("concat_kernel_009", torch.float32, pypto.DT_FP32, (16, 5, 5, 16),
                 [(32, 3, 5, 14), (21, 3, 5, 14)], (53, 3, 5, 14), 0,
                 marks=[pytest.mark.skip()], id="009"),
    pytest.param("concat_kernel_010", torch.int8, pypto.DT_INT8, (2, 10, 9, 32),
                 [(8, 10, 6, 16), (8, 4, 6, 16)], (8, 14, 6, 16), 1,
                 marks=[pytest.mark.skip()], id="010"),
    pytest.param("concat_kernel_011", torch.int16, pypto.DT_INT16, (3, 40, 4, 16),
                 [(6, 20, 9, 31), (6, 20, 23, 31)], (6, 20, 32, 31), 2,
                 marks=[pytest.mark.skip()], id="011"),
    pytest.param("concat_kernel_012", torch.int32, pypto.DT_INT32, (3, 3, 30, 8),
                 [(6, 9, 21, 10), (6, 9, 21, 13)], (6, 9, 21, 23), 3,
                 marks=[pytest.mark.skip()], id="012"),
    pytest.param("concat_kernel_013", torch.float16, pypto.DT_FP16, (5, 10, 5, 16),
                 [(6, 9, 21, 10), (9, 9, 21, 10), (17, 9, 21, 10)],
                 (32, 9, 21, 10), 0, marks=[pytest.mark.skip()], id="013"),
    pytest.param("concat_kernel_014", torch.float32, pypto.DT_FP32, (3, 3, 40, 8),
                 [(6, 9, 21, 10), (6, 21, 21, 10), (6, 16, 21, 10)],
                 (6, 46, 21, 10), 1, marks=[pytest.mark.skip()], id="014"),
    pytest.param("concat_kernel_015", torch.int8, pypto.DT_INT8, (5, 5, 12, 32),
                 [(6, 9, 21, 10), (6, 9, 14, 10), (6, 9, 19, 10)],
                 (6, 9, 54, 10), 2, marks=[pytest.mark.skip()], id="015"),
    pytest.param("concat_kernel_016", torch.int16, pypto.DT_INT16, (5, 8, 12, 16),
                 [(6, 9, 21, 10), (6, 9, 21, 40), (6, 9, 21, 21),
                  (6, 9, 21, 9)], (6, 9, 21, 80), 3,
