...
BIAS_FIXPIPE_TESTS = [
    ...
    {
        "id": "BF03",
        "name": "3d_perchannel_int8_relu",
        "desc": "3D BatchMatmul int8 with PerChannel scale and ReLU",
        "a_trans": True,
        "b_trans": True,
        "input_shape": [[1, 416, 128], [3, 128, 416]],
        "output_shape": [3, 128, 128],
        "a_dtype": "DT_INT8",
        "b_dtype": "DT_INT8",
        "c_dtype": "DT_FP16",
        "view_shape": [3, 128, 128],
        "tile_shape": [[128, 128], [64, 256], [256, 256]],
        "relu_mode": pypto.ReLuType.RELU,
        "mode": "perchannel",
        "products": ["950", "910"],
    },
    {
        "id": "BF04",
        "name": "4d_pertensor_int8_relu",
        "desc": "4D BatchMatmul int8 with PerTensor scale and ReLU",
        "a_trans": False,
        "b_trans": False,
        "input_shape": [[1, 3, 576, 352], [3, 1, 576, 312]],
        "output_shape": [3, 3, 352, 312],
        "a_dtype": "DT_INT8",
        "b_dtype": "DT_INT8",
        "c_dtype": "DT_FP16",
        "view_shape": [3, 3, 352, 312],
        "tile_shape": [[128, 128], [64, 128], [128, 128]],
        "scale": 2.0,
        "relu_mode": pypto.ReLuType.RELU,
        "mode": "pertensor",
        "products": ["950", "910"],
    ...
    },
    {
        "id": "BF07",
        "name": "4d_bias_int8",
        "desc": "4D BatchMatmul int8 with bias",
        "a_trans": True,
        "b_trans": False,
        "input_shape": [[4, 3, 448, 2], [1, 3, 448, 191]],
        "output_shape": [4, 3, 2, 191],
        "a_dtype": "DT_INT8",
        "b_dtype": "DT_INT8",
        "c_dtype": "DT_INT32",
        "view_shape": [4, 3, 1, 100],
        "tile_shape": [[128, 128], [64, 256], [128, 128]],
        "bias_shape": [1, 191],
        "relu_mode": pypto.ReLuType.NO_RELU,
        "bias_dtype": "DT_INT32",
        "mode": "bias",
    ...
    },
    {
        "id": "BF08",
        "name": "4d_bias_fp32",
        "desc": "4D BatchMatmul fp32 with bias",
        "a_trans": False,
        "b_trans": True,
        "input_shape": [[3, 2, 3, 48], [1, 2, 320, 48]],
        "output_shape": [3, 2, 3, 320],
        "a_dtype": "DT_FP32",
        "b_dtype": "DT_FP32",
        "c_dtype": "DT_FP32",
        "view_shape": [3, 2, 2, 64],
        "tile_shape": [[169, 169], [48, 96], [176, 528]],
        "bias_shape": [1, 320],
        "relu_mode": pypto.ReLuType.RELU,
        "bias_dtype": "DT_FP32",
        "mode": "bias",
