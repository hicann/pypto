...
Verifies kernel examples from:
  docs/zh/pypto_pro/api/SIMD-API/计算API/融合算子/mul_add_dst.md
  docs/zh/pypto_pro/api/SIMD-API/计算API/融合算子/fused_mul_add_relu.md
  docs/zh/pypto_pro/api/SIMD-API/计算API/融合算子/partadd.md
"""
