...
"""A5 generalized system test for the SIMT cos interface."""
...
def simt_cos_all_dtypes(
    ...
    with pl.section_vector():
        cos_all_dtypes[ELEMENTS](src_fp16, src_bf16, src_fp32, out_fp16, out_bf16, out_fp32)


@pytest.mark.soc("950")
def test_cos_all_supported_dtypes(run_float_unary):
    ...
    run_float_unary(simt_cos_all_dtypes, values, torch.cos)
