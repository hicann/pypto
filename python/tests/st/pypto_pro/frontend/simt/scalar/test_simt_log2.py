...
"""A5 generalized system test for the SIMT log2 interface."""
...
def simt_log2_all_dtypes(
    ...
    with pl.section_vector():
        log2_all_dtypes[ELEMENTS](src_fp16, src_bf16, src_fp32, out_fp16, out_bf16, out_fp32)


@pytest.mark.soc("950")
def test_log2_all_supported_dtypes(run_float_unary):
    ...
    run_float_unary(simt_log2_all_dtypes, values, torch.log2)
