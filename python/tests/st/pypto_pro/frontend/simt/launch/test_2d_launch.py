...
"""A5 end-to-end test for a two-dimensional SIMT launch."""
...
def add_2d(data: pl.Tile[[1, THREADS], pl.DT_FP32], delta: pl.DT_FP32):
    thread = pl.simt.thread_idx()
    tid = thread.x + thread.y * THREADS_X
...
def simt_2d_launch(
    ...
    with pl.section_vector():
        ...
        pl.simt.launch(add_2d, threads=(THREADS_X, THREADS_Y), args=(data, delta))
