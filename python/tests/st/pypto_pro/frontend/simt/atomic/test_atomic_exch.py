...
def simt_atomic_exch_return_value_gm(
    ...
    with pl.section_vector():
        pl.simt.launch(atomic_exch_return_value_gm, threads=1, args=(state, old_values))
...
def simt_atomic_exch_contention_gm(
    ...
    with pl.section_vector():
        pl.simt.launch(atomic_exch_contention_gm, threads=32, args=(state, old_values))
