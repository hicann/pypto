...
def simt_atomic_and_ub_all_dtypes(
    ...
    with pl.section_vector():
        ...
        pl.simt.launch(atomic_and_ub_all_dtypes, threads=THREADS, args=(int32_tile, uint32_tile))
...
def simt_atomic_and_return_value_gm(
    ...
    with pl.section_vector():
        pl.simt.launch(atomic_and_return_value_gm, threads=1, args=(state, old_values))
