...
"""Mixed Cube/Vector matmul followed by softmax, with SIMD and VF implementations.

Checks the matmul workspace and final probabilities for aligned and tail shapes."""
