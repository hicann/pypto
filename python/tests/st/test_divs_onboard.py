...
def test_divs_onboard():
    ...
    input1 = pypto.tensor(shape, pypto.DataType.DT_FP32, "PTO_TENSOR_input1")
    input2 = 1.5
    output = pypto.tensor(shape, pypto.DataType.DT_FP32, "PTO_TENSOR_output")
    ...
    golden = torch.div(a_tensor, input2)
