...
class SymbolicScalar:
    ...
    @staticmethod
    def check(conds: List[SymbolicScalar]) -> SatStatus: ...
...
class ConfigScope:
    def GetAnyConfig(self, key: str) -> Any: ...
...
def BeginScope(name: str, values: dict, filename: str, lineno: int) -> None: ...

def EndScope() -> None: ...

def CurrentScope() -> 'ConfigScope': ...
...
def ExchangeCaptureModeRelax() -> None: ...
...
@overload
def Assemble(a: Tensor, offset: List[SymbolicScalar], dst: Tensor, parallel: bool = True) -> None: ...
...
def SetLogRotationEnabled(enabled: bool): ...
