...
def Remainder(a: Union[Tensor, Element], b: Union[Tensor, Element], precision_type: RemAlgorithm = RemAlgorithm.HIGH_PRECISION) -> Tensor: ...


def Pow(a: Tensor, b: Union[Tensor, Element], precision_type: PowAlgorithm = PowAlgorithm.HIGH_PRECISION) -> Tensor: ...
