...
inline const std::map<PassName, const char*> kPassNameStringMap = {
    ...
    {PassName::BUILD_TREE_FROM_REDUCE, "BuildTreeFromReduce"},
    ...
    {PassName::VF_FUSION_CLUSTER_IDENTIFY, "VFFusionClusterIdentify"},
