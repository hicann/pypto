...
enum class MemoryState { Critical, Tight, Normal, Abundant };

enum class ConstraintType { HardConstraint, SoftConstraint, Optional };
...
struct SchedulingContext {
    ...
    SchedulingContext() : max_consumer_count(0) {}
};
...
public:
    ...
    MemoryAwareTopoSort(std::vector<Operation*> opList, Function& function) : function_(&function)
    {
        operations = opList;
    }
