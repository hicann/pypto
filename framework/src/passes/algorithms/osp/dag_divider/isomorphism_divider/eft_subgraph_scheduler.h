...
/*!
 * \file eft_subgraph_scheduler.h
 * \brief
 */

#ifndef OSP_EFT_SUBGRAPH_SCHEDULER_H
#define OSP_EFT_SUBGRAPH_SCHEDULER_H
...
public:
     ...
     */
    void SetMinWorkPerProcessor(const VWorkwT<GraphT> minWorkPerProcessor)
    {
        minWorkPerProcessor_ = minWorkPerProcessor;
    }
