...
const std::string COPY_IN_L1_K_INDEX = OP_ATTR_PREFIX + "copy_in_l1_k_index";
...
struct ConvTileInfo {
    ...
    SymbolicScalar dynValidDout = SymbolicScalar(0);
    ...
    SymbolicScalar dynValidDoutL0 = SymbolicScalar(0);
};
