...
private:
    ...
    void PrintPerfTable(std::ostream& out, 
        ...
        out << std::left 
            ...
            << std::setw(18) << "Total Percent(%)"
            << std::setw(15) << "Avg Time(us)"
            << std::setw(18) << "Avg Percent(%)"
        ...
        for (size_t i = 0; i < dataSize; i++) {
            ...
            if (data.count > 0) {
                ...
                out << std::left << std::fixed << std::setprecision(3)
                    << std::setw(40) << data.name
                    << std::setw(12) << data.count
                    << std::setw(15) << totalTimeUs
                    << std::setw(18) << totalPercent
                    << std::setw(15) << avgTimeUs
                    << std::setw(18) << avgPercent
                    << std::setw(15) << maxTimeUs
                    << std::setw(15) << minTimeUs
                    << std::endl;
            }
        }
        ...
        out << std::left 
            ...
            << std::setw(15) << "-"
            << std::setw(15) << static_cast<double>(avgSumNs) / 1000.0
            << std::setw(15) << "-"
            << std::setw(15) << "-"
            << std::setw(15) << "-"
            << std::endl;
