...
REGISTER_CALC_OP(OP_WAIT_FLAG_DEV, Opcode::OP_WAIT_FLAG_DEV, ExecuteOpNone);
REGISTER_CALC_OP(OP_FFTS_CROSS_CORE_SYNC, Opcode::OP_FFTS_CROSS_CORE_SYNC, ExecuteOpNone);
...
REGISTER_CALC_OP(OP_L1_RESHAPE_COPY_IN, Opcode::OP_L1_RESHAPE_COPY_IN, ExecuteOpCopyIn);
} // namespace npu::tile_fwk
