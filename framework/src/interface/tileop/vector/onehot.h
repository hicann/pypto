...
PTO_INST void TZEROS(TileData& dst, int shape3, int shape4)
{
    ...
    if constexpr (std::is_same_v<typename TileData::DType, int64_t>) {
        constexpr size_t int64ToInt32ColRatio = sizeof(int64_t) / sizeof(int32_t);
        using DstTileType = pto::Tile<TileData::Loc, int32_t, TileData::Rows, TileData::Cols * int64ToInt32ColRatio,
                                      pto::BLayout::RowMajor, -1, -1>;
        DstTileType dstTile(shape3, shape4 * int64ToInt32ColRatio);
