...
void NoNestedCallVerifier::RecordError(nested_call::ErrorType type, const std::string& message, const Span& span)
{
...
public:
    ...
    {
        verifier_detail::VerifyFunctionBodies<NoNestedCallVerifier>(program, diagnostics);
    }
};
