    ...
    static inline ScalarImmediateType CalcMopCall(const std::vector<ScalarImmediateType> &immediateList) {
        ...
        switch (immediateList.size()) {
            ...
            case 4:
                ...
                break;
            default: FUNCTION_ASSERT(false) << "immediateList.size(): " << immediateList.size(); break;
        }
        return result;
    }
    ...
    ScalarImmediateType Evaluate(const RawSymbolicScalarPtr &raw) const {
        ...
        switch (raw->Kind()) {
            ...
            case SymbolicScalarKind::T_SCALAR_SYMBOLIC_SYMBOL: {
                ...
                FUNCTION_ASSERT(symbolValueDict->count(symbol->Name())) << symbol->Name() << " has not been found in symbolValueDict";
            ...
            default: FUNCTION_ASSERT(false) << " undefined behavior."; break;
        }
        return result;
    }
};
