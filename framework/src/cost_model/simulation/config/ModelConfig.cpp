...
ModelConfig::ModelConfig()
{
    ...
    Config::recorder = {
        ...
        {"genCalendarScheduleCpp", [&](){ return "genCalendarScheduleCpp = " + ParameterToStr(genCalendarScheduleCpp); }},
        ...
        {"coreMachineNumberPerAICPU", [&](){ return "coreMachineNumberPerAICPU = " + ParameterToStr(coreMachineNumberPerAICPU); }},
        {"cubeMachineNumberPerAICPU", [&](){ return "cubeMachineNumberPerAICPU = " + ParameterToStr(cubeMachineNumberPerAICPU); }},
        {"vecMachineNumberPerAICPU", [&](){ return "vecMachineNumberPerAICPU = " + ParameterToStr(vecMachineNumberPerAICPU); }},
        ...
        {"simulationFixedLatencyTask", [&](){ return "simulationFixedLatencyTask = " + ParameterToStr(simulationFixedLatencyTask); }},
        {"fixedLatencyTaskInfoPath", [&](){ return "fixedLatencyTaskInfoPath = " + fixedLatencyTaskInfoPath; }},
        {"fixedLatencyTimeConvert", [&](){ return "fixedLatencyTimeConvert = " + ParameterToStr(fixedLatencyTimeConvert); }},
