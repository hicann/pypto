...
class AICPUStats : public CostModel::BaseStats {
public:
    ...
    std::map<uint64_t, uint64_t> threadSubmitNum;
    std::map<uint64_t, uint64_t> threadResolveNum;
    std::map<uint64_t, uint64_t> threadBatchNum;
