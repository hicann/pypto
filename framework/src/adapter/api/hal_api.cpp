...
HalError HalMemCtl(int type, void* paramValue, size_t paramValueSize, void* outValue, size_t* outSizeRet)
{
    ...
    if (func != nullptr) {
        drvError_t(*halFunc)(int, void*, size_t, void*, size_t*) =
            reinterpret_cast<drvError_t(*)(int, void*, size_t, void*, size_t*)>(func);
...
HalError HalResMap(unsigned int devId, struct ResMapInfo* resInfo, unsigned long* va, unsigned int* len)
{
    ...
    if (func != nullptr) {
        drvError_t(*halFunc)(unsigned int, struct res_map_info*, unsigned long*, unsigned int*) =
            reinterpret_cast<drvError_t(*)(unsigned int, struct res_map_info*, unsigned long*, unsigned int*)>(func);
...
HalError HalGetDeviceInfoByBuff(uint32_t devId, int32_t moduleType, int32_t infoType, void* buf, int32_t* size)
{
    ...
    if (func != nullptr) {
        drvError_t(*halFunc)(uint32_t, int32_t, int32_t, void*, int32_t*) =
            reinterpret_cast<drvError_t(*)(uint32_t, int32_t, int32_t, void*, int32_t*)>(func);
