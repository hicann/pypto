...
uint64_t CalcStitchWorkspace(DevAscendProgram& devProg)
{
    ...
    uint32_t objUsedNum[CALC_STITCH_NUM] = {READY_QUEUE_SIZE,         DIE_READY_QUEUE_SIZE * DIE_NUM,    1,
                                            MAX_AICORE_NUM_FOR_QUEUE, DRCO_QUEUE_MAX * NUM_LOCAL_GROUPS, DRCO_QUEUE_MAX,
                                            MAX_STITCH_FUNC_NUM};
