...
void BuildGraphForTest(std::shared_ptr<Function>& currFunctionPtr, std::vector<Operation*>& opListPtr)
{
    ...
    setflag1.syncQueue_ = {PipeType::PIPE_MTE2, PipeType::PIPE_V, CoreType::AIV, CoreType::AIV, 0, AIVCore::AIV0};
    ...
    setflag2.syncQueue_ = {PipeType::PIPE_V, PipeType::PIPE_MTE3, CoreType::AIV, CoreType::AIV, 0, AIVCore::AIV0};
    opListPtr.emplace_back(&setflag2);
    auto& waitflag1 = currFunctionPtr->AddRawOperation(Opcode::OP_SYNC_DST, {input}, {output});
    waitflag1.syncQueue_ = {PipeType::PIPE_MTE2, PipeType::PIPE_V, CoreType::AIV, CoreType::AIV, 0, AIVCore::AIV0};
    ...
    waitflag2.syncQueue_ = {PipeType::PIPE_V, PipeType::PIPE_MTE3, CoreType::AIV, CoreType::AIV, 0, AIVCore::AIV0};
