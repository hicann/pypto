...
TestCodeGenSigmoid::TestCodeGenSigmoid() = default;
TestCodeGenSigmoid::~TestCodeGenSigmoid() = default;

TestCodeGenSigmoid& TestCodeGenSigmoid::Instance()
{
    static TestCodeGenSigmoid instance;
    return instance;
}

void TestCodeGenSigmoid::test_sigmoid_fp16_001()
{
