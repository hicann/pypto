...
class TestCodeGenAmin : public CodegenTestLiteNPU {};

// fp16 test cases
TEST_F(TestCodeGenAmin, test_amin_fp16_001)
{
    PROGRAM("AMIN_FP16_001")
    {
        TileShape::Current().SetVecTile({48});
        Tensor operand(DT_FP16, {112}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_001") { result = Amin(operand, -1, false); }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "AMIN_FP16_001");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(TestCodeGenAmin, test_amin_fp16_002)
{
    PROGRAM("AMIN_FP16_002")
    {
        TileShape::Current().SetVecTile({96});
        Tensor operand(DT_FP16, {100}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_002") { result = Amin(operand, -1, false); }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "AMIN_FP16_002");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(TestCodeGenAmin, test_amin_fp16_003)
{
    PROGRAM("AMIN_FP16_003")
    {
        TileShape::Current().SetVecTile({2, 32});
        Tensor operand(DT_FP16, {4, 128}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_003") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_004)
{
    PROGRAM("AMIN_FP16_004")
    {
        TileShape::Current().SetVecTile({1, 128});
        Tensor operand(DT_FP16, {4, 130}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_004") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_005)
{
    PROGRAM("AMIN_FP16_005")
    {
        TileShape::Current().SetVecTile({1, 2, 32});
        Tensor operand(DT_FP16, {2, 4, 160}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_005") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_006)
{
    PROGRAM("AMIN_FP16_006")
    {
        TileShape::Current().SetVecTile({1, 2, 128});
        Tensor operand(DT_FP16, {2, 4, 140}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_006") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_007)
{
    PROGRAM("AMIN_FP16_007")
    {
        TileShape::Current().SetVecTile({1, 5, 32});
        Tensor operand(DT_FP16, {2, 5, 152}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_007") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_008)
{
    PROGRAM("AMIN_FP16_008")
    {
        TileShape::Current().SetVecTile({1, 3, 160});
        Tensor operand(DT_FP16, {2, 3, 170}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_008") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_009)
{
    PROGRAM("AMIN_FP16_009")
    {
        TileShape::Current().SetVecTile({2, 1, 2, 16});
        Tensor operand(DT_FP16, {5, 2, 4, 176}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_009") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_010)
{
    PROGRAM("AMIN_FP16_010")
    {
        TileShape::Current().SetVecTile({1, 1, 1, 128});
        Tensor operand(DT_FP16, {5, 2, 4, 130}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_010") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_011)
{
    PROGRAM("AMIN_FP16_011")
    {
        TileShape::Current().SetVecTile({1, 1, 5, 32});
        Tensor operand(DT_FP16, {2, 3, 5, 134}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_011") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_012)
{
    PROGRAM("AMIN_FP16_012")
    {
        TileShape::Current().SetVecTile({2, 2, 3, 32});
        Tensor operand(DT_FP16, {4, 2, 6, 135}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_012") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_013)
{
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_014)
{
    PROGRAM("AMIN_FP16_014")
    {
        TileShape::Current().SetVecTile({1, 2, 1, 128});
        Tensor operand(DT_FP16, {3, 2, 3, 139}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_014") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp16_015)
{
    PROGRAM("AMIN_FP16_015")
    {
        TileShape::Current().SetVecTile({3, 3, 5, 32});
        Tensor operand(DT_FP16, {6, 3, 5, 141}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP16_015") { result = Amin(operand, -1, false); }
    }
...
// fp32 test cases
TEST_F(TestCodeGenAmin, test_amin_fp32_001)
{
    PROGRAM("AMIN_FP32_001")
    {
        TileShape::Current().SetVecTile({48});
        Tensor operand(DT_FP32, {112}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_001") { result = Amin(operand, -1, false); }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "AMIN_FP32_001");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(TestCodeGenAmin, test_amin_fp32_002)
{
    PROGRAM("AMIN_FP32_002")
    {
        TileShape::Current().SetVecTile({96});
        Tensor operand(DT_FP32, {100}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_002") { result = Amin(operand, -1, false); }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "AMIN_FP32_002");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_003)
{
    PROGRAM("AMIN_FP32_003")
    {
        TileShape::Current().SetVecTile({2, 32});
        Tensor operand(DT_FP32, {4, 128}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_003") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_004)
{
    PROGRAM("AMIN_FP32_004")
    {
        TileShape::Current().SetVecTile({1, 128});
        Tensor operand(DT_FP32, {4, 130}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_004") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_005)
{
    PROGRAM("AMIN_FP32_005")
    {
        TileShape::Current().SetVecTile({1, 2, 32});
        Tensor operand(DT_FP32, {2, 4, 160}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_005") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_006)
{
    PROGRAM("AMIN_FP32_006")
    {
        TileShape::Current().SetVecTile({1, 2, 128});
        Tensor operand(DT_FP32, {2, 4, 140}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_006") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_007)
{
    PROGRAM("AMIN_FP32_007")
    {
        TileShape::Current().SetVecTile({1, 5, 32});
        Tensor operand(DT_FP32, {2, 5, 152}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_007") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_008)
{
    PROGRAM("AMIN_FP32_008")
    {
        TileShape::Current().SetVecTile({1, 3, 168});
        Tensor operand(DT_FP32, {2, 3, 170}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_008") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_009)
{
    PROGRAM("AMIN_FP32_009")
    {
        TileShape::Current().SetVecTile({2, 1, 2, 16});
        Tensor operand(DT_FP32, {5, 2, 4, 176}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_009") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_010)
{
    PROGRAM("AMIN_FP32_010")
    {
        TileShape::Current().SetVecTile({1, 1, 1, 128});
        Tensor operand(DT_FP32, {5, 2, 4, 130}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_010") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_011)
{
    PROGRAM("AMIN_FP32_011")
    {
        TileShape::Current().SetVecTile({1, 1, 5, 32});
        Tensor operand(DT_FP32, {2, 3, 5, 134}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_011") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_012)
{
    PROGRAM("AMIN_FP32_012")
    {
        TileShape::Current().SetVecTile({2, 2, 3, 32});
        Tensor operand(DT_FP32, {4, 2, 6, 135}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_012") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_013)
{
    PROGRAM("AMIN_FP32_013")
    {
        TileShape::Current().SetVecTile({1, 1, 4, 128});
        Tensor operand(DT_FP32, {6, 2, 4, 130}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_013") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_014)
{
    PROGRAM("AMIN_FP32_014")
    {
        TileShape::Current().SetVecTile({1, 2, 1, 136});
        Tensor operand(DT_FP32, {3, 2, 3, 139}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_014") { result = Amin(operand, -1, false); }
    }
...
TEST_F(TestCodeGenAmin, DISABLED_test_amin_fp32_015)
{
    PROGRAM("AMIN_FP32_015")
    {
        TileShape::Current().SetVecTile({3, 3, 5, 32});
        Tensor operand(DT_FP32, {6, 3, 5, 141}, "operand");
        Tensor result;
        FUNCTION("AMIN_FP32_015") { result = Amin(operand, -1, false); }
    }
