...
TestCodeGenMaximum::TestCodeGenMaximum() = default;
TestCodeGenMaximum::~TestCodeGenMaximum() = default;

TestCodeGenMaximum& TestCodeGenMaximum::Instance()
{
    static TestCodeGenMaximum instance;
    return instance;
}

void TestCodeGenMaximum::test_maximum_int16_001()
{
