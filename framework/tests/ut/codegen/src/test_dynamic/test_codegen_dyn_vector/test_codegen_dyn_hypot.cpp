...
/*!
 * \file test_codegen_dyn_hypot.cpp
 * \brief Unit test for hypot codegen.
 */
...
class TestCodegenDynHypot : public CodegenTestBase {
public:
    TestCodegenDynHypot() : CodegenTestBase({.compileStage = CS_EXECUTE_GRAPH}) {}
};
