...
TEST_F(TestCodegenDynBinary, TestAddSTileTensorInfPos)
{
    std::vector<std::string> expect = {
        ...
        R"!!!(TAddS<LastUse2Dim<0, 1>, float>(ubTensor_0, ubTensor_0, float_inf_pos.f);)!!!"};
...
TEST_F(TestCodegenDynBinary, TestAddSTileTensorInfNeg)
{
    std::vector<std::string> expect = {
        ...
        R"!!!(TAddS<LastUse2Dim<0, 1>, float>(ubTensor_0, ubTensor_0, float_inf_neg.f);)!!!"};
...
TEST_F(TestCodegenDynBinary, TestAddSTileTensorNAN)
{
    std::vector<std::string> expect = {
        ...
        R"!!!(TAddS<LastUse2Dim<0, 1>, float>(ubTensor_0, ubTensor_0, float_nan.f);)!!!"};
...
uint64_t sym_14_dim_0 = GET_PARAM_VALID_SHAPE_BY_IDX(param, 2, 19, 2, 0);
uint64_t sym_14_dim_1 = GET_PARAM_VALID_SHAPE_BY_IDX(param, 2, 19, 2, 1);
...
GMTileTensorFP32Dim2_1 gmTensor_1((__gm__ float*)(RUNTIME_GET_PARAM_ADDR(RUNTIME_param, 1, 10)), DynLayout2Dim(Shape2Dim((RUNTIME_COA_GET_PARAM_RAW_SHAPE(2, 10, 0)), (RUNTIME_COA_GET_PARAM_RAW_SHAPE(2, 10, 1))), Stride2Dim(GET_PARAM_STRIDE_2(param, 1, 10))));
...
GMTileTensorFP32Dim2_1 gmTensor_3((__gm__ float*)(RUNTIME_GET_PARAM_ADDR(RUNTIME_param, 0, 1)), DynLayout2Dim(Shape2Dim((RUNTIME_COA_GET_PARAM_RAW_SHAPE(2, 1, 0)), (RUNTIME_COA_GET_PARAM_RAW_SHAPE(2, 1, 1))), Stride2Dim(GET_PARAM_STRIDE_2(param, 0, 1))));
...
GMTileTensorFP32Dim2_1 gmTensor_7((__gm__ float*)(RUNTIME_GET_PARAM_ADDR(RUNTIME_param, 2, 19)), DynLayout2Dim(Shape2Dim((RUNTIME_COA_GET_PARAM_RAW_SHAPE(2, 19, 0)), (RUNTIME_COA_GET_PARAM_RAW_SHAPE(2, 19, 1))), Stride2Dim(GET_PARAM_STRIDE_2(param, 2, 19))));
...
SUBKERNEL_PHASE1
GMTileTensorFP32Dim2_2 gmTensor_2((__gm__ float*)GET_PARAM_ADDR(param, 1, 10), DynLayout2Dim(Shape2Dim((RUNTIME_COA_GET_PARAM_RAW_SHAPE(2, 10, 0)), (RUNTIME_COA_GET_PARAM_RAW_SHAPE(2, 10, 1))), Stride2Dim(GET_PARAM_STRIDE_2(param, 1, 10))));
...
GMTileTensorFP32Dim2_2 gmTensor_4((__gm__ float*)GET_PARAM_ADDR(param, 0, 1), DynLayout2Dim(Shape2Dim((RUNTIME_COA_GET_PARAM_RAW_SHAPE(2, 1, 0)), (RUNTIME_COA_GET_PARAM_RAW_SHAPE(2, 1, 1))), Stride2Dim(GET_PARAM_STRIDE_2(param, 0, 1))));
