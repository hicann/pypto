...
struct ArgMinOpFuncArgs : public OpFuncArgs {
    ArgMinOpFuncArgs(std::vector<int64_t> viewShape, const std::vector<int64_t> tileShape, std::vector<int64_t> dims,
                     const bool keepDim)
...
INSTANTIATE_TEST_SUITE_P(TestArgMin, ArgMinOperationTest,
