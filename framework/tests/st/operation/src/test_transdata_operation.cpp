...
static void TransDataOperationExeFunc4Dims(
...
static void TransDataOperationExeFunc5Dims(
    const std::vector<Tensor>& inputs, std::vector<Tensor>& outputs, const OpFuncArgs* opArgs)
{
    const TransDataOpFuncArgs* transDataInfo = static_cast<const TransDataOpFuncArgs*>(opArgs);
...
static void TransDataOperationExeFunc6Dims(
    const std::vector<Tensor>& inputs, std::vector<Tensor>& outputs, const OpFuncArgs* opArgs)
{
    const TransDataOpFuncArgs* transDataInfo = static_cast<const TransDataOpFuncArgs*>(opArgs);
...
INSTANTIATE_TEST_SUITE_P(
    TestTransData, TransDataOperationTest,
    ::testing::ValuesIn(GetOpMetaData<TransDataOpMetaData>(
        {TransDataOperationExeFunc4Dims, TransDataOperationExeFunc4Dims, TransDataOperationExeFunc4Dims,
         TransDataOperationExeFunc5Dims, TransDataOperationExeFunc6Dims},
        "TransData")));
