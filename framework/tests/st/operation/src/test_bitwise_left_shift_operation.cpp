...
static void BitwiseLeftShiftOperationExeFunc5Dims(
    const std::vector<Tensor>& inputs, std::vector<Tensor>& outputs, const OpFuncArgs* opArgs)
{
    FUNCTION("main", {inputs[0], inputs[1]}, {outputs[0]})
    {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::ValuesIn(GetOpMetaData<BitwiseLeftShiftOpMetaData>(
        {BitwiseLeftShiftOperationExeFunc2Dims, BitwiseLeftShiftOperationExeFunc3Dims, BitwiseLeftShiftOperationExeFunc4Dims, BitwiseLeftShiftOperationExeFunc5Dims},
        "BitwiseLeftShift")));
