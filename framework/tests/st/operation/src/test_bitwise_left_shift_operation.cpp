...
/*!
 * \file test_bitwise_left_shift_operation.cpp
 * \brief
 */
...
static void BitwiseLeftShiftOperationExeFunc2Dims(const std::vector<Tensor>& inputs, std::vector<Tensor>& outputs,
...
static void BitwiseLeftShiftOperationExeFunc3Dims(const std::vector<Tensor>& inputs, std::vector<Tensor>& outputs,
                                                  const OpFuncArgs* opArgs)
{
    FUNCTION("main", {inputs[0], inputs[1]}, {outputs[0]})
    {
...
static void BitwiseLeftShiftOperationExeFunc4Dims(const std::vector<Tensor>& inputs, std::vector<Tensor>& outputs,
                                                  const OpFuncArgs* opArgs)
{
    FUNCTION("main", {inputs[0], inputs[1]}, {outputs[0]})
    {
...
static void BitwiseLeftShiftOperationExeFunc5Dims(const std::vector<Tensor>& inputs, std::vector<Tensor>& outputs,
                                                  const OpFuncArgs* opArgs)
{
    FUNCTION("main", {inputs[0], inputs[1]}, {outputs[0]})
    {
...
INSTANTIATE_TEST_SUITE_P(TestBitwiseLeftShift, BitwiseLeftShiftOperationTest,
                         ::testing::ValuesIn(GetOpMetaData<BitwiseLeftShiftOpMetaData>(
                             {BitwiseLeftShiftOperationExeFunc2Dims, BitwiseLeftShiftOperationExeFunc3Dims,
                              BitwiseLeftShiftOperationExeFunc4Dims, BitwiseLeftShiftOperationExeFunc5Dims},
                             "BitwiseLeftShift")));
