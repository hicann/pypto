...
/*!
 * \file test_signbit_operation.cpp
 * \brief
 */
...
namespace {
struct SignbitOpFuncArgs : public OpFuncArgs {
    SignbitOpFuncArgs(const std::vector<int64_t> &viewShape, const std::vector<int64_t> tileShape)
...
struct SignbitOpMetaData {
    explicit SignbitOpMetaData(const OpFunc &opFunc, const nlohmann::json &test_data)
...
static void SignbitOperationExeFunc2Dims(
    ...
    FUNCTION("main", {inputs[0]}, {outputs[0]}) {
        ...
        const struct SignbitOpFuncArgs *args = static_cast<const SignbitOpFuncArgs *>(opArgs);
...
static void SignbitOperationExeFunc4Dims(
    ...
    FUNCTION("main", {inputs[0]}, {outputs[0]}) {
        ...
        auto args = static_cast<const SignbitOpFuncArgs *>(opArgs);
        const int firstViewShape = args->viewShape_[0];
        const int secondViewShape = args->viewShape_[1];
        const int thirdViewShape = args->viewShape_[2];
...
TEST_P(SignbitOperationTest, TestSignbit) {
    ...
    auto args = SignbitOpFuncArgs(GetViewShape(test_data), GetTileShape(test_data));
    auto testCase = CreateTestCaseDesc<SignbitOpMetaData>(GetParam(), &args);
