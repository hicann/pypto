...
public:
     ...
     */
    BackendOpRegistryEntry(Backend* backend, std::string op_name) : backend_(backend), op_name_(std::move(op_name)) {}
 ...
 * Provides operator registration and abstract methods for backend-specific operations.
 */
class Backend {
public:
    /**
