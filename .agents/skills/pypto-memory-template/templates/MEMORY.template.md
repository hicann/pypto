...
List **every operation** in the PyPTO-friendly golden. During module verification, cross-check line-by-line against the PyPTO implementation and mark ✅/❌. **Do not run tests or advance modules while any ❌ remains.**
