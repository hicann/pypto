...
示例：
```bash
python3 .agents/skills/pypto-operator-auto-tuner/perf-analyzer/scripts/analyze_perf.py <output_dir>
```
...
性能分析报告模板：".agents/skills/pypto-operator-auto-tuner/perf-analyzer/templates/performance_report_template.md"
性能分析报告应包含以下内容：
