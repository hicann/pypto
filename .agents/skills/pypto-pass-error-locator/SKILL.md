...
4. 常规安装命令：`python3 build_ci.py --clean --no_isolation && bash build_out/cann-pypto_*.run --full -q --pylocal`
...
- [查看计算图](../../../docs/zh/guide/programming_guide/tensor/debug/debug.md#查看计算图)
...
### API文档
- [Pass配置API](../../../docs/zh/api/tensor_api/config/pypto-set_pass_options.md)
