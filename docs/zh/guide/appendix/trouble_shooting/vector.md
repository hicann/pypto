...
1. 查阅对应算子文档（如[pypto.add](../../../api/tensor_api/operation/pypto-add.md)、[pypto.sin](../../../api/tensor_api/operation/pypto-sin.md)、[pypto.cast](../../../api/tensor_api/operation/pypto-cast.md)、[pypto.amax](../../../api/tensor_api/operation/pypto-amax.md)）确认输入输出Shape、维度等满足要求。
...
1. 查阅对应算子文档（如[pypto.add](../../../api/tensor_api/operation/pypto-add.md)、[pypto.sin](../../../api/tensor_api/operation/pypto-sin.md)、[pypto.cast](../../../api/tensor_api/operation/pypto-cast.md)）确认输入输出数据类型满足要求，切换为兼容的数据类型重试。
...
1. 查阅对应算子文档（如[pypto.pow](../../../api/tensor_api/operation/pypto-pow.md)、[pypto.gcd](../../../api/tensor_api/operation/pypto-gcd.md)、[pypto.amax](../../../api/tensor_api/operation/pypto-amax.md)）确认支持的维度范围，并保证各输入Tensor维度数一致且在范围内。
...
1. 对照打屏日志中的操作数期望个数，查阅对应算子文档（如[pypto.scatter_](../../../api/tensor_api/operation/pypto-scatter_.md)、[pypto.concat](../../../api/tensor_api/operation/pypto-concat.md)、[pypto.where](../../../api/tensor_api/operation/pypto-where.md)）确认输入输出个数与调用方式匹配。
...
1. 查阅[pypto.set_vec_tile_shapes](../../../api/tensor_api/config/pypto-set_vec_tile_shapes.md)及对应算子文档确认TileShape取值满足要求。

2. 调用[pypto.set_vec_tile_shapes](../../../api/tensor_api/config/pypto-set_vec_tile_shapes.md)前确认各维度均为正数、维度数不超过4，且与输出维度一致。
...
3. 通过[pypto.get_vec_tile_shapes](../../../api/tensor_api/config/pypto-get_vec_tile_shapes.md)回读实际生效的TileShape，核对是否符合切分约束：
...
1. 查阅对应算子文档（如[pypto.amax](../../../api/tensor_api/operation/pypto-amax.md)）及[pypto.set_vec_tile_shapes](../../../api/tensor_api/config/pypto-set_vec_tile_shapes.md)确认对齐要求。关注reshape/view、交换维度（转置）等是否改变内轴对齐要求，必要时调整Tensor形状或TileShape取值。
