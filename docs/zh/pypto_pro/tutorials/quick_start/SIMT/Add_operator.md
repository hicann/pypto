...
| Tile分配 | 使用[pl.make_tile](../../../api/SIMD-API/operation/resource_management/make_tile.md)分配片上内存 |
| 数据搬入 | 通过[pl.load](../../../api/SIMD-API/operation/memory_data_movement/load.md)将GM数据搬入UB Tile |
| 数据计算 | 通过[pl.simt.launch](../../../api/SIMT-API/execution/launch.md)启动一维线程块，每个线程通过[pl.simt.thread_idx](../../../api/SIMT-API/execution/thread_idx.md)获取线程编号并更新一个Tile元素 |
...
> - 如需进一步了解PyPTO Pro的SIMT编程模型，请参阅[SIMT编程模型](../../programming_paradigm/simt_programming.md)。
