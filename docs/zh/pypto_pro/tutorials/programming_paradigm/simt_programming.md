...
传入SIMT函数的Tensor需要使用ND Layout；Tile需要是二维ND Vec Tile。Tensor和Tile必须以完整变量传给pl.simt.launch，元素下标表达式、Slice和Tile Subview不能作为launch实参。具体限制请参见[simt.launch](../../api/SIMT-API/execution/launch.md)。
...
- [Add算子（SIMT）快速入门](../quick_start/SIMT/Add_operator.md)
- [SIMT API](../../api/SIMT-API/index.md)
- [simt.launch](../../api/SIMT-API/execution/launch.md)
- [SIMT执行](../../api/SIMT-API/execution/index.md)
