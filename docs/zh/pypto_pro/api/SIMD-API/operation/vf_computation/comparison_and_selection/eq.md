...
| 参数 | 输入/输出 | 说明 |
|---|---|---|
| `a` | 输入 | 源操作数，reg_tensor。支持的数据类型为：DT_INT8、DT_UINT8、DT_INT16、DT_UINT16、DT_FP16、DT_BF16、DT_INT32、DT_UINT32、DT_FP32。 |
| `b` | 输入 | 比较操作数，可以是标量或reg_tensor，数据类型与`a`一致。`a`和`b`可以是同一个reg_tensor。 |
