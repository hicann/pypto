...
| compile_monitor_enable    | 输入      | 含义：控制编译阶段监控模式 <br> 说明：<br> 0: 关闭 Compiler Monitor; <br> 1: 开启 Compiler Monitor，关闭 Pass 明细; <br> 2: 开启 Compiler Monitor，开启 Pass 明细。 <br> 取值范围: int [0, 2] <br> 默认值: 0 |
