...
def shifted_exp(
    ...
    output[0, tid] = pl.simt.exp(source[0, tid] - maximum)
...
def simt_exp_kernel(
    ...
    with pl.section_vector():
        pl.simt.launch(shifted_exp, threads=256, args=(source, output, maximum))
```
