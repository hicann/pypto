...
def binary_log(
    ...
    output[0, tid] = pl.simt.log2(pl.simt.max(source[0, tid], epsilon))


@pl.jit()
def simt_log2_kernel(
    source: pl.Tensor[[1, 256], pl.DT_FP32],
    output: pl.Tensor[[1, 256], pl.DT_FP32],
    epsilon: pl.DT_FP32,
):
