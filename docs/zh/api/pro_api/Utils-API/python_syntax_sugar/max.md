...
在Kernel代码中可直接使用Python内置max(lhs, rhs)，编译时会自动转换为pypto_pro.language.max(lhs, rhs)，取两个标量中的较大值。
...
- **Tile逐元素取最大值**：使用[pypto_pro.language.maximum](../../SIMD-API/tile_computation/elementwise/maximum.md)
