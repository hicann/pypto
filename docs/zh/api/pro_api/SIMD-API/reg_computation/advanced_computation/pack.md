...
def example_vf(src_tile, dst_tile):
    ...
    # pack提取偶数位到低半部分，unpack再展开恢复，roundtrip后掩码不变
...
def example_vf_int64(src_tile, dst_tile):
    ...
    # pack: INT64 → UINT32 (extract low 32 bits of each element, pack dst must be unsigned)
    ...
    # unpack: INT32 → INT64 (restore, sign-extends high 32 bits)
