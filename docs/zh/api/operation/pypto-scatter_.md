...
| 参数名  | 输入/输出 | 说明                                                                 |
|---------|-----------|----------------------------------------------------------------------|
| input   | 输入      | 支持的类型为：Tensor。 <br> Tensor支持的数据类型为：当src为Element时，Atlas A2系列产品/Atlas A3系列产品：DT_INT8, DT_INT16, DT_INT32, DT_FP16, DT_FP32, DT_BF16；Atlas A5系列产品：DT_INT8, DT_UINT8, DT_INT16, DT_INT32, DT_FP16, DT_FP32, DT_BF16。当src为Tensor时，Atlas A2系列产品/Atlas A3系列产品：DT_INT8, DT_UINT8, DT_INT16, DT_INT32, DT_UINT32, DT_FP16, DT_FP32, DT_BF16；Atlas A5系列产品：DT_INT8, DT_UINT8, DT_INT16, DT_INT32, DT_FP16, DT_FP32, DT_BF16。 <br> 不支持空Tensor；Shape仅支持1-4维；Shape Size不大于2147483647（即INT32_MAX）。 |
...
| src     | 输入      | src是更新的标量或Tensor。 <br> src为Element时，支持的数据类型为：Atlas A2系列产品/Atlas A3系列产品：DT_INT8, DT_INT16, DT_INT32, DT_FP16, DT_FP32, DT_BF16；Atlas A5系列产品：DT_INT8, DT_UINT8, DT_INT16, DT_INT32, DT_FP16, DT_FP32, DT_BF16，不支持输入INF/NAN <br> src为Tensor时，支持的数据类型为：Atlas A2系列产品/Atlas A3系列产品：DT_INT8, DT_UINT8, DT_INT16, DT_INT32, DT_UINT32, DT_FP16, DT_FP32, DT_BF16；Atlas A5系列产品：DT_INT8, DT_UINT8, DT_INT16, DT_INT32, DT_FP16, DT_FP32, DT_BF16，数据类型和 input 保持一致。 <br> |
