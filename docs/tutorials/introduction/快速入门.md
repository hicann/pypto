...
Softmax算子实现的example代码位于：examples/02\_intermediate/operators/softmax/softmax.py，用户可结合代码示例理解本节内容。
...
切换到示例代码所在目录examples/02\_intermediate/operators/softmax/softmax.py，在已安装PyPTO的环境中运行：
