...
slicing语法糖的完整样例请参考：examples/01\_beginner/00\_introduction/add\_scalar\_loop.py
...
view/assemble接口完整样例请参考：examples/01\_beginner/00\_introduction/add\_scalar\_loop\_view\_assemble.py
