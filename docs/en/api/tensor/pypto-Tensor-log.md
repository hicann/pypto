...
<!-- md-trans-meta sourceCommit=d92d51ac286ac6802735f52dae2fade039bbc9b3 translatedAt=2026-08-26T02:47:55.484Z pushedAt=2026-08-28T11:36:17.382Z -->
...
```python
log(self, precision_type: PrecisionType = PrecisionType.INTRINSIC) -> 'Tensor'
```
...
See [pypto.log](../operation/pypto-log.md).
