...
<!-- md-trans-meta sourceCommit=14b69d18385f30130c8cd22ddda0e75ec338bdd9 translatedAt=2026-09-02T09:02:52.664Z pushedAt=2026-09-05T07:36:26.381Z -->
...
Returns the upper triangular part of a 2D tensor or a batch of tensors. The other elements of the result tensor are set to 0.
...
| diagonal  | Input        | Diagonal offset, defaulting to **0** (the main diagonal).<br>Type: **SymInt**.                                                                                                                                                          |

## Return Value

Returns a tensor whose shape and data type are the same as those of the input.
