...
在调用`pypto.matmul`或`pypto.scaled_mm`前必须调用本接口设置矩阵运算的切分大小，具体切分配置可参考[Matmul高性能编程](https://gitcode.com/cann/pypto/blob/master/docs/tutorials/debug/matmul_performance_guide.md)。
